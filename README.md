...
<head>
  ...
  <title>Avijit Pradhan | Portfolio</title>
  <style>
    * {
      margin: 0;
      padding: 0;
    ...
    /* Header */
    header {
      background: linear-gradient(135deg, hsl(176, 98%, 55%), #39ebb3);
      background-size: 300% 300%;
      animation: gradientMove 8s infinite alternate;
      color: white;
      text-align: center;
      padding: 70px 20px;
      border-bottom: 3px solid #47e3c4;
      box-shadow: 0 8px 25px rgba(3, 23, 14, 0.2);
    }
    header img {
      width: 150px;
      height: 150px;
      ...
      object-fit: cover;
      box-shadow: 0 6px 20px rgba(25, 238, 210, 0.6);
    }
    header h1 {
      font-size: 2.8rem;
      margin-top: 15px;
